...
$supplier = mysqli_query($conn, "select id, user_name from users where user_type='supplier'");
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    <form method="GET" class="form-group">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label for="customer_id" class="mr-2">Select Supplier:</label>
                                                <select name="supplier_id" id="supplier_id" class="form-control mr-2">
                                                    <option value="">All supplier</option>
                                                    <?php while ($suppliers = mysqli_fetch_assoc($supplier)) { ?>
                                                        <option value="<?php echo $suppliers['id']; ?>"
                                                            <?php echo ($suppliers['id'] == $selected_supplier) ? 'selected' : ''; ?>>
                                                            <?php echo $suppliers['user_name']; ?>
                                                        </option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-right">
                                            <a href="addpurchase_return.php" class="btn btn-primary me-2">
                                                <i class="fas fa-plus"></i> Add New Purchase Return
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <table id="example2" class="table table-bordered table-striped table-hover" style="text-align: center;">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_assoc($invoices)) {
                                                ...
                                                // $user_id = $row['user_id'];
                                                // $user_query = mysqli_query($conn, "select user_name from users where id='$user_id'");
                                                ...
                                                <td>
                                                    <div class='btn-group' role='group'>
                                                        <a href='print_purchasereturn.php?id={$row['id']}' class='btn btn-outline-primary m-1'>View</a>
                                                        " . '<button class="btn btn-outline-danger  deleteBtn m-1" data-id="' . $row['id'] . '">Delete</button>' . "
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">#Purchase Return Invoice</h4>
    ...
    <script>
        ...
        $(document).on("click", ".paymentbtn", function(e) {
            ...
            $("#paymentform").submit(function(e) {
                ...
                // let bankcheque=$("#cheque_no").val();

                e.preventDefault();
                let formData = new FormData($("#paymentform")[0]);
                // console.log(formData);
                $.ajax({
                    url: "add_paymentpurchasereturn.php",
                    type: "POST",
                    data: formData,
                    dataType: "json",
                    processData: false,
