                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-right">
                                            <a href="addpayment_in.php" class="btn btn-primary me-2">
                                ...
                                <div class="card-body">
                                    <table id="example2" class="table table-bordered table-striped table-hover" style="text-align: center;">
                                        ...
                                        <tbody>
                                            <?php
                                            $query = mysqli_query($conn, "select u.user_name,u.user_type,p.* from payment p left join users u on u.id=p.user_id where u.user_type='customer'");
