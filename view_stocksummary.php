                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <table id="example2" class="table table-bordered table-striped table-hover" style="text-align: center;">
                                            ...
                                            <tbody>
                                                <?php
                                                $query = mysqli_query($conn, "select p.name as product , d.qty as quantity , i.*, u.user_name as customer
                                                from invoice_details d left join products p 
                                                on d.product_id = p.id
                                                left join invoice i on d.invoice_id = i.id
                                                LEFT JOIN users u ON i.user_id = u.id
                                                where p.id='$id' and i.invoice_type='sales';
                                                ");
