                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="example2" class="table table-bordered table-striped table-hover" style="text-align: center;">
                                        ...
                                        <tbody>
                                            <?php
                                            $query=mysqli_query($conn,"select p.*, s.qty as quantity,c.name as category,b.name as brand
                                            from products p left join stock s 
                                            ...
                                            while($row=mysqli_fetch_assoc($query)){
                                                ...
                                                <td>
                                                <a href='view_stocksummary.php?id={$row['id']}' class='btn btn-outline-primary'>View</a>
                                                </td>
                                                </tr>
                                                " ;}
                                            ?>
