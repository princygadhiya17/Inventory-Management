    ...
    <body class="hold-transition sidebar-mini layout-fixed">
                                    ...
                                    <div class="card-header">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 text-right">
                                                <a href="exportpurchase.php" class="btn btn-primary">Export in Excel</a>
                                                <a href="purchasereport_pdf.php" class="btn btn-primary">Generate pdf</a>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.card-header -->
        ...
        <script>
            ...
            //     let fp=XLSX.utils.table_to_book(data,{sheet:'purchase'});
            //     XLSX.writeFile(fp,"ExportPurchase.xlsx");
            // }
        </script>
