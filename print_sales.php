                            ...
                            <div class="invoice p-3 mb-3">
                                ...
                                <div class="row invoice-info">
                                    ...
                                    <div class="col-sm-4 invoice-col">
                                        ...
                                        <br>
                                        <b>Order ID:</b> - <br>
                                        <b>Payment Due Date : </b><?php echo $date->format('d/m/Y');
                                                                    ?><br>
                                        <b>Account:</b> -
                                    </div>
                                    <!-- /.col -->
                                ...
                                <div class="row no-print">
                                    <div class="col-12">
                                        <a href="sales_pdf.php?id=<?php echo $inv['id']; ?>" rel="noopener" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>
                                        <button type="button" class="btn btn-success float-right"><i class="far fa-credit-card"></i> Submit
                                            Payment
                                        </button>
                                        <a href="viewsales_pdf.php?id=<?php echo $inv['id']; ?>"
                                            target="_blank"
