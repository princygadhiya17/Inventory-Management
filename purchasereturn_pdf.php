                        ...
                        <div class="col-12">
                            ...
                            <div class="invoice p-3 mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <!-- /.col -->
                                    <div class="col-6">
                                        <p class="lead"> Amount Due Date :<?php
                                                                            $date = date_create($inv['invoice_date']);
                                                                            echo date_format($date, "d/m/Y");
                                                                            ?></p>
                                ...
                                <!-- <div class="row no-print">
                                    <div class="col-12">
                                        <a href="generate_print.php" rel="noopener" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>
