                                ...
                                <div class="card-header">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-right">
                                            <a href="add_brand.php" class="btn btn-primary me-2">
                                    ...
                                    <table id="example2" class="table table-bordered table-striped table-hover" style="text-align: center;">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                echo "<tr>
                                        <td><img src='upload/brand/{$row['logo']}' width='50' height='50'></td>
                                        <td>{$row['name']}</td>
                                        <td>
                                        ...
                                        <td>
                                            <div class='btn-group' role='group'>
                                                <a href='add_brand.php?id={$row['id']}' class='btn btn-outline-primary m-2'>Edit</a>
