    ...
    <body class="hold-transition sidebar-mini layout-fixed">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h3 class="card-title">Purchase ReturnList</h3>
                                            </div>
                                            <div class="col-md-6 text-right">
                                                <a href="exportsalesreturn.php" class="btn btn-primary">Export in Excel</a>
                                                <a href="purchasereturnreport_pdf.php" class="btn btn-primary">Generate pdf</a>
                                            </div>
        ...
        <script>
            ...
            function export_data() {
                ...
                XLSX.writeFile(fp, "ExportPurchasereturn.xlsx");
            }
        </script>
