...
<body class="hold-transition sidebar-mini layout-fixed">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-right">
                                            <a href="addsales_return.php" class="btn btn-primary me-2">
                                                <i class="fas fa-plus"></i> Add New Sales Return
                                            </a>
                                        </div>
                                ...
                                <div class="card-body">
                                    <table id="example2" class="table table-bordered table-striped table-hover" style="text-align: center;">
                                        ...
                                        <tbody>
                                            <?php
                                            // $result = mysqli_query($conn, "select * from invoice where invoice_type='sales'");
                                        ...
                                        <td>
                                            <div class='btn-group' role='group'>
                                             <a href='print_salesreturn.php?id={$row['id']}' class='btn btn-outline-primary m-1'>View</a>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">#Sales Return Invoice</h4>
    ...
    <script>
        ...
        $("#paymentform").submit(function(e) {
            ...
            $.ajax({
                url: "add_paymentsalesreturn.php",
                type: "POST",
                data: formData,
                dataType: "json",
                processData: false,
