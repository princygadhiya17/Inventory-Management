                                ...
                                <div class="card-header">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-right">
                                            <a href="add_suppliers.php" class="btn btn-primary me-2">
                                ...
                                <div class="card-body">
                                    <table id="example2" class="table table-bordered table-striped table-hover" style="text-align: center;">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $result = mysqli_query($conn, "select * from users where user_type='supplier'");
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                $statusText = $row['status'] == 1 ? "checked" : "";

                                                echo "<tr>
                                        <td><img src='upload/supplier/{$row['image']}' width='50' height='50'></td>
                                        <td>{$row['user_name']}</td>
                                        <td>{$row['password']}</td>
                                        ...
                                        <td>
                                            <div class='btn-group' role='group'>
                                                <a href='add_suppliers.php?id={$row['id']}' class='btn btn-outline-primary m-2'>Edit</a>
