...
<body class="hold-transition sidebar-mini layout-fixed">
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-right">
                                            <a href="add_purchase.php" class="btn btn-primary me-2">
                                               ...
                                               <td>
                                                ...
                                                <td>
                                                    <div class='btn-group' role='group'>
                                                        <a href='print_purchase.php?id={$row['id']}' class='btn btn-outline-primary m-1'>View</a>
                                                        <a href='add_purchase.php?id={$row['id']}' class='btn btn-outline-primary m-1 editbtn'>Edit</a>
    ...
    <script>
        ...
        //         if (payment == 'paid' || payment == 'partialpaid') {
