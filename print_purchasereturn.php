...
");
 $date=new DateTime($inv['invoice_date']);
?>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <div class="invoice p-3 mb-3">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <h4>
                                            ...
                                            <small class="float-right">Purchase Date: <?php echo $date->format('d/m/Y'); ?> </small>
                                        </h4>
                                    </div>
                                    <!-- /.col -->
                                </div>
                                ...
                                <div class="row invoice-info">
                                    ...
                                    <div class="col-sm-4 invoice-col">
                                        ...
                                        <br>
                                        <b>Order ID:</b> - <br>
                                        <b>Payment Date : </b><?php echo $date->format('d/m/Y') ?><br>
                                        <b>Account:</b> -
                                    </div>
                                    <!-- /.col -->
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <!-- /.col -->
                                    <div class="col-6">
                                        <p class="lead"> Amount Due Date : <?php echo $date->format('d/m/Y'); ?></p>
                                ...
                                <div class="row no-print">
                                    <div class="col-12">
                                        <a href="purchasereturn_pdf.php?id=<?php echo $inv['id']; ?>" rel="noopener" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>
                                        <button type="button" class="btn btn-success float-right"><i class="far fa-credit-card"></i> Submit
                                            Payment
                                        </button>
                                         <a href="viewpurchasereturn_pdf.php?id=<?php echo $inv['id']; ?>"
                                            target="_blank"
