                            ...
                            <div class="col-md-12">
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Payment Out</h3>
                                    </div>
                                    <div class="card-body">
                                        <!-- form start -->
                                        <form method="POST" action="save_payment_out.php" enctype="multipart/form-data">
                                            <div class="row">
                                                <div class="col-md-3 mb-3">
                                                    <label class="form-label">Supplier</label>
                                                    <div class="input-group">
                                                        <select class="form-select" name="user_id" id="supplier_id" required>
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" id='price' name='rate' step="0.01" placeholder="Enter amount" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <?php $date = date("Y-m-d"); ?>
                                                        <input type="date" name="invoice_date" id="salesdate" class="form-control" value="<?php echo $date; ?>" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#supplier_id').on('change', function() {
                    ...
                    $.ajax({
                        url: 'fetch_supplier_payment.php',
                        type: 'POST',
                        data: {
                            user_id: user_id
                        },
